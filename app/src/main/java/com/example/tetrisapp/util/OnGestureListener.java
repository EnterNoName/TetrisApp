...
public class OnGestureListener implements View.OnTouchListener {
    ...
    public OnGestureListener(Context ctx) {
        gestureDetector = new GestureDetector(ctx, new GestureListener() {
            ...
            public boolean onDoubleTap(@NonNull MotionEvent e) {
                OnGestureListener.this.onDoubleTap();
                return true;
            }
        });
    }
    ...
    public static class GestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        /**
         * Given two points in the plane p1=(x1, x2) and p2=(y1, y1), this method
         * returns the distance traveled in the given direction.
         *
         * @param direction the general direction from p1 to p1
         * @param x1        the x position of the first point
         * @param y1        the y position of the first point
         * @param x2        the x position of the second point
         * @param y2        the y position of the second point
         * @return distance traveled in the direction
         */
        public float getDistance(Direction direction, float x1, float y1, float x2, float y2) {
            float result = 0;
